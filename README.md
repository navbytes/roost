...
[![Version](https://img.shields.io/badge/version-0.1.22-informational.svg)](Cargo.toml)
...
Pin a version by appending it, e.g. `github:navbytes/roost@0.1.22`, or swap
`@branch:main` for `@tag:v0.1.22` on the cargo backend. Drop `-g` to pin roost
